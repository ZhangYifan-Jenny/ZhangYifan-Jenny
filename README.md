...
I am currently open to opportunities **worldwide**, including:

- **Postdoctoral positions** in Bayesian statistics, psychometrics, quantitative methodology, biostatistics, latent variable modeling, and statistical machine learning
- **Industry positions** such as Machine Learning Engineer, Applied Scientist, AI Engineer, Research Scientist, and Data Scientist

## 🔬 Research Interests

- Bayesian statistics and Bayesian regularization
- Latent variable modeling and structural equation modeling
- Psychometrics and educational measurement
- Statistical machine learning
- AI/ML reliability and trustworthy AI
- Computational statistics and statistical software

## 📦 Featured Project

### [BRLVM](https://github.com/ZhangYifan-Jenny/BRLVM)

**Bayesian Regularized Latent Variable Modeling**

An R package for Bayesian regularized latent variable modeling, developed as part of my PhD research.

📖 [Documentation](https://zhangyifan-jenny.github.io/BRLVM/)
